...
tap.test("gauge() - creating a gauge with labels and then not populating them", (t) => {
	const gauge = new Gauge({
		name: "valid_name",
		description: "Valid description",
...
tap.test("gauge() - creating a gauge with labels and then populating them", (t) => {
	const gauge = new Gauge({
		name: "valid_name",
		description: "Valid description",
		labels: { first: undefined, second: undefined, third: undefined },
...
tap.test("gauge() - creating a gauge without labels and then populating them", (t) => {
	const gauge = new Gauge({
		name: "valid_name",
		description: "Valid description",
	});
...
tap.test("gauge() - creating a gauge with some labels and then populating them others (merge)", (t) => {
	const gauge = new Gauge({
		name: "valid_name",
		description: "Valid description",
