...
tap.test("histogram() - creating a basic histogram without options throws", (t) => {
	t.throws(() => new Histogram());
	t.end();
});

tap.test("histogram().observe() - calling observe with no argument throws", (t) => {
...
tap.test("histogram() - creating a basic histogram with minimal arguments", (t) => {
	const histogram = new Histogram({
		name: "valid_name",
		description: "Valid description",
	});
...
tap.test("histogram() - creating a histogram with labels and then not populating them", (t) => {
	const histogram = new Histogram({
		name: "valid_name",
		description: "Valid description",
...
tap.test("histogram() - creating a histogram with labels and then populating them", (t) => {
	const histogram = new Histogram({
		name: "valid_name",
		description: "Valid description",
		labels: { first: undefined, second: undefined, third: undefined },
...
tap.test("histogram() - creating a histogram without labels and then populating them", (t) => {
	const histogram = new Histogram({
		name: "valid_name",
		description: "Valid description",
	});
...
tap.test("histogram() - creating a histogram with some labels and then populating them others (merge)", (t) => {
	const histogram = new Histogram({
		name: "valid_name",
		description: "Valid description",
...
tap.test("histogram() - using timer to time a number of seconds, label merge", (t) => {
	const clock = fakeTimers.install();
