...
tap.test("summary() - creating a summary with labels and then not populating them", (t) => {
	const summary = new Summary({
		name: "valid_name",
		description: "Valid description",
...
tap.test("summary() - creating a summary with labels and then populating them", (t) => {
	const summary = new Summary({
		name: "valid_name",
		description: "Valid description",
		labels: { first: undefined, second: undefined, third: undefined },
...
tap.test("summary() - creating a summary without labels and then populating them", (t) => {
	const summary = new Summary({
		name: "valid_name",
		description: "Valid description",
	});
...
tap.test("summary() - creating a summary with some labels and then populating them others (merge)", (t) => {
	const summary = new Summary({
		name: "valid_name",
		description: "Valid description",
...
tap.test("summary() - using timer to time a number of seconds, label merge", (t) => {
	const clock = fakeTimers.install();
